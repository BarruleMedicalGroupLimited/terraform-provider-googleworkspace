...
Setup:
```bash
mkdir -p ~/.terraform.d/plugins/registry.terraform.io/barrulemedicalgrouplimited/googleworkspace/5.0.0/darwin_amd64
ln -s $GOBIN/terraform-provider-googleworkspace ~/.terraform.d/plugins/registry.terraform.io/barrulemedicalgrouplimited/googleworkspace/5.0.0/darwin_amd64/terraform-provider-googleworkspace_v5.0.0
```
...
```bash
rm -rf ~/.terraform.d/plugins/registry.terraform.io/barrulemedicalgrouplimited/
```
